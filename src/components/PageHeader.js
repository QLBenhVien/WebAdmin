...
const PageTitle = styled('div')(({ theme }) => ({
    ...
    '& .MuiTypography-subtitle2': { // Thay đổi kiểu cho subtitle2
...
export default function PageHeader(props) {
    ...
    return (
        <Root elevation={0} square> {/* Sử dụng Root với độ cao 0 và hình vuông */}
            <PageHeaderContainer> {/* Container cho tiêu đề và biểu tượng */}
                <PageIcon> {/* Hiển thị biểu tượng */}
                    {icon}
                </PageIcon>
                <PageTitle> {/* Hiển thị tiêu đề và phụ đề */}
                    <Typography variant="h6" component="div"> {/* Tiêu đề */}
                        {title}
                    </Typography>
                    <Typography variant="subtitle2" component="div"> {/* Phụ đề */}
                        {subTitle}
                    </Typography>
                </PageTitle>
            </PageHeaderContainer>
