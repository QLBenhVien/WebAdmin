                ...
                <div style={styles.mainContent}>
                    ...
                    <div style={styles.pageContainer}>
                        ...
                        <div style={styles.InfoContainer}>
                            <form style={styles.form}>
                                <div style={styles.fullWidth}>
                                    ...
                                    <input style={styles.input} type="text" defaultValue="Nguyễn Văn A" />
                                </div>
                                <div>
                                ...
                                <div style={styles.fullWidth}>
                                    ...
                                    <input style={styles.input} type="text" defaultValue="0923444444" />
                                </div>
                                <div style={styles.fullWidth}>
                                    <label style={styles.label}>Địa chỉ</label>
                                    <input style={styles.input} type="text" defaultValue="Ấp 2, Tắc Vân, TP. Cà Mau" />
                                </div>
                                <div style={styles.fullWidth}>
                                ...
                                <div style={styles.fullWidth}>
                                    ...
                                    <input style={styles.input} type="text" defaultValue="Khó thở" />
                                </div>
                                <div style={styles.fullWidth}>
                        ...
                        <div style={styles.buttonContainer}>
                            <button style={styles.backButton} onClick={() => navigateTo('/quanlydatkham')}>Tạo</button>
