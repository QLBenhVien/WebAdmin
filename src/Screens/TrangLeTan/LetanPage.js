    ...
    return (
        <div style={styles.sidebar}>
            ...
            <ul style={styles.sidebarList}>
                <li style={{ ...styles.sidebarItem, backgroundColor: '#FFFFFF', color: '#000000' }} onClick={() => navigateTo('/letanhome')}>Trang chủ</li>
                    ...
                    <div style={styles.pageContainer}>
                        ...
                        <div style={styles.contentRow}>
                            ...
                            <div style={styles.infoCardsColumn}>
                                <InfoCard title="Quản lý đặt khám" content="1" icon={<div style={styles.icon}>📋</div>} />
                                <InfoCard title="Lập Phiếu khám bệnh" content="1" icon={<div style={styles.icon}>📄</div>} />
                            </div>
                        </div>
