                            ...
                            <table style={styles.table}>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style={styles.td}>BN01</td>
                                        <td style={styles.td}>Nguyễn Văn A</td>
                                        <td style={styles.td}>15/09/2024</td>
                                        <td style={styles.td}>chờ duyệt</td>
                                        <td style={styles.td}><button style={styles.actionButton} onClick={() => navigateTo('/thongtindatkham')}>Xem</button> | <button style={styles.actionButton}>Chỉnh sửa</button></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
